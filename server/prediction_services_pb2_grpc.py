...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in prediction_services_pb2_grpc.py depends on'
...
def add_LstmServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('services.LstmService', rpc_method_handlers)
...
def add_NlpServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('services.NlpService', rpc_method_handlers)
