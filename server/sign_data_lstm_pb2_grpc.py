...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in sign_data_lstm_pb2_grpc.py depends on'
...
def add_StreamDataServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('signDataLSTM.StreamDataService', rpc_method_handlers)
